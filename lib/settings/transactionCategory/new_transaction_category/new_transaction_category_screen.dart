...
class NewTransactionCategoryScreen extends HookConsumerWidget {
  ...
  const NewTransactionCategoryScreen({Key? key, this.transactionCategory})
      : super(key: key);

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final _name =
        useState(transactionCategory != null ? transactionCategory!.name : '');

    final _description = useState(
        transactionCategory != null ? transactionCategory!.description : '');

    final _transactionType = useState(transactionCategory != null
