...
final updateTransactionCategoryControllerProvider = StateNotifierProvider<
        UpdateTransactionCategoryController, TransactionCategory>(
    (ref) => UpdateTransactionCategoryController(ref.read));

class UpdateTransactionCategoryController
    extends StateNotifier<TransactionCategory> {
  final Reader _read;
  String ledgerName = '';
  UpdateTransactionCategoryController(this._read)
      : super(
          TransactionCategory(
            name: '',
            description: '',
  ...
  save() {
    _read(transactionCategoryRepositoryProvider).update(payload: state);
  }
}
