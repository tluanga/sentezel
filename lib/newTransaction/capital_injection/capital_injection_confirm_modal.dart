...
class CapitalInjectionConfirmationBottomSheet extends HookConsumerWidget {
  final Function onConfirm;
  final Function onCancel;
  final double itemFontSize = 16;
  const CapitalInjectionConfirmationBottomSheet({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(capitalInjectionControllerProvider).data!.value;
