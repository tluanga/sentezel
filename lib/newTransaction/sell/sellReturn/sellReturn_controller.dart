...
final sellReturnControllerProvider =
    StateNotifierProvider<SellReturnController, AsyncValue<Transaction>>(
        (ref) => SellReturnController(ref.read)..init());

class SellReturnController extends StateNotifier<AsyncValue<Transaction>> {
  final Reader _read;
  ...
  //------------For Initialization--------
  final int _transactionCategoryId = TransactionCategoryIndex.SalesReturn;
  init() async {
