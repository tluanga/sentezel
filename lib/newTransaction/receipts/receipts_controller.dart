...
final receiptsControllerProvider =
    StateNotifierProvider<ReceiptsController, AsyncValue<Transaction>>(
        (ref) => ReceiptsController(ref.read)..init());

class ReceiptsController extends StateNotifier<AsyncValue<Transaction>> {
  final Reader _read;
  ...
  ReceiptsController(this._read) : super(AsyncValue.loading());

  //------------For Initialization--------
  final int _transactionTypeId = TransactionTypeIndex.RentReceived;
  init() async {
